            ...
            {links.map((link) => (
              <li key={link.href}>
                <Link
                  ...
                  className={
                    isActive(link.href)
                      ? "bg-linear-to-r from-violet-600 via-pink-500 to-amber-400 bg-clip-text text-transparent border-2 border-b-pink-500 hover:opacity-90 transition-opacity duration-200 font-semibold bg-base-200"
                      : ""
                  }
                >
                  {link.label}
            ...
            {!session && (
              <>
                ...
                <li>
                  <Link
                    href="/auth/signup"
                    className="bg-linear-to-r from-violet-600 via-pink-500 to-amber-400 bg-clip-text text-transparent hover:opacity-90 transition-opacity duration-200 font-semibold"
                  >
                    Sign Up
                  </Link>
                </li>
      ...
      <div className="navbar-end gap-2">
        {isPending ? (
          ...
          <>
            <Link
              href="/auth/signin"
              className="btn btn-ghost hidden sm:inline-flex hover:bg-base-200 transition-colors"
            >
              Log In
            </Link>
            <Link
